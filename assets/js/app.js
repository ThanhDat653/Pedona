import {products as defaultProducts, carts as cartList, users as userList} from './storage.js'
...
function description() {    
    ...
    productDescriptionElement = document.querySelectorAll(".product__description");
    closeDescriptionBtn = document.querySelectorAll(".product__description--close");
...
const pcQuantityInput = document.querySelectorAll(".product__description .input-qty");
...
const mobileQuantityInput = document.querySelectorAll(".mobile-product__information .input-qty");
...
function addToCart() {
    sItem('userCurrent', JSON.stringify({name: 'Nguyen Thanh Dat', cartID: "1"}));
